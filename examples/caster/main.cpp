...
int init(int& argc, char** argv)
{
    ...
    if (cusCastInit(argc, argv, keydir.c_str(), newProcessedImageFn, newRawImageFn, newSpectralImageFn,
        newImuData, freezeFn, buttonFn, progressFn, errorFn, width, height) < 0)
    {
